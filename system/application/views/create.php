		...
		<!-- content-wrap starts here -->
			...
			<div id="main">
				...
				<?php echo form_open('lib_vmin/create');?>
				   <table>
				   <tr><td>Name</td><td>:</td><td><input type="text" name="name"/s></td></tr>
				    <tr><td>Memory</td><td>:</td><td><select>
				     ...
				     <tr><td>Container Template</td><td>:</td><td><input type="checkbox" name="template1" value="http"/> Http Server <br/>
				      ...
				      <tr><td colspan="2"><input type="reset" value="Reset"/></td><td><input type="submit" name="Create"/></td></tr>
				   </table>
				</form>
